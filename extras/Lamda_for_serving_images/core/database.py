...
db_session = scoped_session(sessionmaker(autocommit=False, autoflush=False, bind=engine, expire_on_commit=False)) # expire_on_commit estaba en True, checamos que todo cool
