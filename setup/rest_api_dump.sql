...
CREATE TABLE `emailpool` (
  ...
  CONSTRAINT `emailpool_idTemplate` FOREIGN KEY (`template_id`) REFERENCES `emailtemplate` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `emailsent` (
  ...
  CONSTRAINT `emailsent_idTemplate` FOREIGN KEY (`template_id`) REFERENCES `emailtemplate` (`id`)
...
--
-- Table structure for table `pushnotificationcatalogue`
--

DROP TABLE IF EXISTS `pushnotificationcatalogue`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pushnotificationcatalogue` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `pushnotificationcatalogue`
--

LOCK TABLES `pushnotificationcatalogue` WRITE;
/*!40000 ALTER TABLE `pushnotificationcatalogue` DISABLE KEYS */;
INSERT INTO `pushnotificationcatalogue` VALUES (1,'GOTO_USER_PROFILE');
/*!40000 ALTER TABLE `pushnotificationcatalogue` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `pushnotificationpool`
--

DROP TABLE IF EXISTS `pushnotificationpool`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pushnotificationpool` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `template_id` int NOT NULL,
  `status_id` int NOT NULL,
  ...
  CONSTRAINT `pushnotificationpool_idTemplate` FOREIGN KEY (`template_id`) REFERENCES `pushnotificationtemplate` (`id`),
  CONSTRAINT `pushnotificationpool_idUser` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pushnotificationpool`
--

LOCK TABLES `pushnotificationpool` WRITE;
/*!40000 ALTER TABLE `pushnotificationpool` DISABLE KEYS */;
/*!40000 ALTER TABLE `pushnotificationpool` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `pushnotificationsent`
--

DROP TABLE IF EXISTS `pushnotificationsent`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pushnotificationsent` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  ...
  KEY `pushnotificationsent_idStatus_idx` (`idStatus`),
  CONSTRAINT `pushnotificationsent_idDevice` FOREIGN KEY (`device_id`) REFERENCES `device` (`id`),
  CONSTRAINT `pushnotificationsent_idStatus` FOREIGN KEY (`idStatus`) REFERENCES `status` (`id`),
  CONSTRAINT `pushnotificationsent_idTemplate` FOREIGN KEY (`template_id`) REFERENCES `pushnotificationtemplate` (`id`),
  CONSTRAINT `pushnotificationsent_idUser` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pushnotificationsent`
--

LOCK TABLES `pushnotificationsent` WRITE;
/*!40000 ALTER TABLE `pushnotificationsent` DISABLE KEYS */;
/*!40000 ALTER TABLE `pushnotificationsent` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `pushnotificationtemplate`
--

DROP TABLE IF EXISTS `pushnotificationtemplate`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pushnotificationtemplate` (
  ...
  CONSTRAINT `pushnotificationtemplate_idCatalogue` FOREIGN KEY (`catalogue_id`) REFERENCES `pushnotificationcatalogue` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pushnotificationtemplate`
--

LOCK TABLES `pushnotificationtemplate` WRITE;
/*!40000 ALTER TABLE `pushnotificationtemplate` DISABLE KEYS */;
/*!40000 ALTER TABLE `pushnotificationtemplate` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-05-05 22:17:43
