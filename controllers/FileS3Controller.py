...
class FileS3Controller(Controller):
    ...
    def on_get(self, req:Request, resp:Response, id:int=None):
        ...
        if not file:
            self.response(resp, 404, error = "No se encontro un archivo con ese id")
            return
    ...
    def on_delete(self, req:Request, resp:Response, id:int=None):
        ...
        if not deleted:
            self.response(resp, 500, error = "Error eliminando el archivo del S3")
            return
    ...
    def on_post_base64(self, req:Request, resp:Response, id:int=None):
        ...
        file = self.__create_file_s3(file_name, base64_info, mimetype, encode_to_base64=False)
    ...
    def on_post(self, req:Request, resp:Response, id:int=None):
        ...
        try:
            ...
            for part in form:
                ...
                file = self.__create_file_s3(part.filename, part_data, part.content_type)
                ...
                if make_thumbnail and ('jpeg' in part.content_type or 'png' in part.content_type or 'jpg' in part.content_type):
                    ...
                    thumbnail = self.__create_file_s3(thumbnail_name, thumbnail_content, part.content_type, is_thumbnail=True)
    ...
    def __create_file_s3(self, file_name, file_content, file_type, is_thumbnail=False, encode_to_base64=True):
        ...
        file = FileManager.put_file(self.bucket, file_content, file_hash, file_type=file_type, 
                                    file_name=file_name, region=self.region, is_thumbnail=is_thumbnail)
