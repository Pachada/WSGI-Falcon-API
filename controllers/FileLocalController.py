...
class FileLocalController(Controller):
    ...
    def on_post_image(self, req: Request, resp: Response, id: int = None):
        ...
        return self.__post_local_handler(req, resp, encode_to_base64=False)
    ...
    def on_post_local(self, req: Request, resp: Response, id: int = None):
        ...
        return self.__post_local_handler(req, resp, encode_to_base64=True)

    def __create_file_local(
        self,
        file_name: str,
        file_content,
        file_type,
    ...
    def __post_local_handler(self, req: Request, resp: Response, encode_to_base64):
        ...
        for part in form:
            ...
            if make_thumbnail and (
                ...
                thumbnail = self.__create_file_local(
                    thumbnail_name,
                    thumbnail_content,
                    part.content_type,
                    is_thumbnail_flag=1,
