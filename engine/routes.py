...
class RouteLoader():
    ...
    def loadRoutes(self):
        ...
        self.server.add_route(self.context_prefix + '/files/local', fileController, suffix='local')
        self.server.add_route(self.context_prefix + '/files/local/{id:int}', fileController, suffix='local')
